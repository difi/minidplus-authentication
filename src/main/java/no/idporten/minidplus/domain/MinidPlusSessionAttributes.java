...
public class MinidPlusSessionAttributes {
    ...
    public static final String HTTP_SESSION_REDIRECT_URL = "redirectUrl";
    public static final String HTTP_SESSION_FORCE_AUTH = "ForceAuth";
    public static final String HTTP_SESSION_GX_CHARSET = "gx_charset";
    public static final String HTTP_SESSION_LOCALE = "locale";
    public static final String HTTP_SESSION_GOTO = "goto";
    public static final String HTTP_SESSION_SERVICE = "service";
    public static final String HTTP_SESSION_START_SERVICE = "start-service" ;
